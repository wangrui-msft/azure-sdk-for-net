...
namespace Azure.Communication.Rooms.Tests
{
    public class RoomsClientTest
    {
        ...
        public async Task CreateRoomAsyncShouldSucceed()
        {
            ...
            Response<RoomResult>? expectedRoomResult = default;
            ...
            Response<RoomResult> actualResponse = await mockRoomsClient.Object.CreateRoomAsync(createRoomRequest, cancellationToken);
        ...
        public async Task UpdateRoomAsyncShouldSucceed()
        {
            ...
            Response<RoomResult> actualResponse = await mockRoomsClient.Object.UpdateRoomAsync(roomId, updateRoomRequest, cancellationToken);
        ...
        public async Task GetRoomAsyncShouldSucceed()
        {
            ...
            Response<RoomResult> actualResponse = await mockRoomsClient.Object.GetRoomAsync(roomId, cancellationToken);
        ...
        public void CreateRoomShouldSucceed()
        {
            Mock<RoomsClient> mockRoomsClient = new Mock<RoomsClient>();
            CreateRoomRequest createRoomRequest = new CreateRoomRequest();
            Response<RoomResult>? expectedRoomResult = new Mock<Response<RoomResult>>().Object;
            CancellationToken cancellationToken = new CancellationTokenSource().Token;
            ...
            Response<RoomResult> actualResponse = mockRoomsClient.Object.CreateRoom(createRoomRequest, cancellationToken);
        ...
        public void UpdateRoomShouldSucceed()
        {
            ...
            Response<RoomResult> actualResponse = mockRoomsClient.Object.UpdateRoom(roomId, updateRoomRequest, cancellationToken);
        ...
        public void GetRoomShouldSucceed()
        {
            ...
            Response<RoomResult> actualResponse = mockRoomsClient.Object.GetRoom(roomId, cancellationToken);
